  ...
  return (
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-2.5 mb-2">
          <div className="pt-2 pb-2 pl-2 pr-2 ml-[14px] bg-white rounded-lg shadow-sm border border-gray-100">
                    <MapPin size={18} className="text-gray-400" strokeWidth={2} />
            </div>
          <h3 className="ml-1 mr-4 mt-4 mb-4 text-sm font-semibold text-gray-900 tracking-tight">
