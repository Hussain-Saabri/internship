            ...
            <Table className="w-full border-collapse">
              ...
              <TableHeader>
                <TableRow className="bg-gray-50 border-b border-gray-200 h-12">
                  ...
                  <TableHead className="px-2 py-3 text-left font-bold text-[10px] text-gray-900 tracking-wider uppercase whitespace-nowrap pl-6">
                    Platform
                  </TableHead>

                  <TableHead className="px-2 py-3 text-left font-bold text-[10px] text-gray-900 tracking-wider uppercase whitespace-nowrap">
                    Orders
                  </TableHead>
                  ...
                  <TableHead className="px-2 py-3 text-center font-bold text-[10px] text-gray-900 tracking-wider uppercase whitespace-nowrap pr-6">
                    Action
                  </TableHead>
